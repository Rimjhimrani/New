...
def main():
    ...
    with tab3:
        ...
        with col1:
            st.metric("Logo Box", "0.3" cm", help="Fixed width for logo")
        with col2:
            st.metric("ASSLY Header", "0.2 cm", help="Fixed width for 'ASSLY' text")
        with col3:
            st.metric("ASSLY Value", "0.4 cm", help="Fixed width for assembly name")
